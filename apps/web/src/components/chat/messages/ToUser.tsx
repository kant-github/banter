  ...
  return (
    <div className="flex items-start gap-2 max-w-sm self-start mb-2">
      <div className="flex flex-row items-center gap-x-2">
        ...
        />
        <div onDoubleClick={likeHandler} className="flex flex-col rounded-tr-[5px] rounded-bl-[5px] rounded-br-[5px] px-3 py-1 text-sm font-light bg-gradient-to-r from-zinc-200 to-gray-300 text-black relative select-none">
