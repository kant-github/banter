                ...
                <div className="absolute border-[1px] dark:border-zinc-800 cursor-pointer right-8 mt-2 w-36 font-light dark:bg-[#1c1c1c] bg-white rounded-[4] shadow-lg ring-1 ring-black ring-opacity-5">
                    <div className="py-1">
                        ...
                        <a
                            ...
                            className="flex flex-row justify-between px-4 py-2 text-xs text-blue-300 dark:text-blue-200 bg-blue-50 dark:bg-blue-600 dark:hover:bg-blue-500 hover:bg-blue-100"
                        >
                            Github
                            <GithubSvg />
                        </a>
