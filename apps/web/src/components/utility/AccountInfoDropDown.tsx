...
export default function AccountInfoModal({ session, setAccountInfoDropDown }: Props) {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
            <div className="bg-white dark:bg-zinc-800 dark:text-gray-200 p-6 rounded-lg shadow-lg w-6/12 relative">
                ...
                <div className="bg-zinc-700 rounded-[4px] p-2 pl-8 mt-4">
                    <div className="mt-6 flex w-full">
                        ...
                        />
                        <div className="w-4/5 bg-zinc-600 font-thin text-[12px] px-4 py-2 relative">
                    ...
                    <div className="flex flex-col gap-y-2">
                        ...
                        <div className="mb-2">
                            <div className="text-lg font-medium">Joined At</div>
                            <div className="font-thin text-md">
                                {userData?.created_at
